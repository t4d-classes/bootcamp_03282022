    ...
    return (
        <form>
            ...
            <fieldset>
                ...
                <label style={{ display: 'block' }}>
                    First Name:
                    <input type="text" name="authorFirstName" value={bookForm.authorFirstName} onChange={change} />
                </label>
                <label style={{ display: 'block' }}>
                    Last Name:
                    <input type="text" name="authorLastName" value={bookForm.authorLastName} onChange={change} />
                </label>
                <label style={{ display: 'block' }}>
                    Phone Number:
                    <input type="text" name="authorPhoneNumber" value={bookForm.authorPhoneNumber} onChange={change} />
                </label>
            </fieldset>
